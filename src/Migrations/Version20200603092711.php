 ...
 */
final class Version20200603092711 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__video AS SELECT id, id_canal_id, id_categoria_id, titulo, descripcion, mg, dislike, duracion FROM video');
        $this->addSql('DROP TABLE video');
        $this->addSql('CREATE TABLE video (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, id_canal_id INTEGER NOT NULL, id_categoria_id INTEGER NOT NULL, titulo VARCHAR(100) NOT NULL COLLATE BINARY, descripcion VARCHAR(255) DEFAULT NULL COLLATE BINARY, mg INTEGER NOT NULL, dislike INTEGER NOT NULL, duracion VARCHAR(15) NOT NULL COLLATE BINARY, fecha_publicacion DATE NOT NULL, CONSTRAINT FK_7CC7DA2C3800B7BB FOREIGN KEY (id_canal_id) REFERENCES canal (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_7CC7DA2C10560508 FOREIGN KEY (id_categoria_id) REFERENCES categoria (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO video (id, id_canal_id, id_categoria_id, titulo, descripcion, mg, dislike, duracion) SELECT id, id_canal_id, id_categoria_id, titulo, descripcion, mg, dislike, duracion FROM __temp__video');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__video AS SELECT id, id_canal_id, id_categoria_id, titulo, descripcion, mg, dislike, duracion FROM video');
        $this->addSql('DROP TABLE video');
        $this->addSql('CREATE TABLE video (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, id_canal_id INTEGER NOT NULL, id_categoria_id INTEGER NOT NULL, titulo VARCHAR(100) NOT NULL, descripcion VARCHAR(255) DEFAULT NULL, mg INTEGER NOT NULL, dislike INTEGER NOT NULL, duracion VARCHAR(15) NOT NULL)');
        $this->addSql('INSERT INTO video (id, id_canal_id, id_categoria_id, titulo, descripcion, mg, dislike, duracion) SELECT id, id_canal_id, id_categoria_id, titulo, descripcion, mg, dislike, duracion FROM __temp__video');
        $this->addSql('DROP TABLE __temp__video');
        $this->addSql('CREATE INDEX IDX_7CC7DA2C3800B7BB ON video (id_canal_id)');
        $this->addSql('CREATE INDEX IDX_7CC7DA2C10560508 ON video (id_categoria_id)');
