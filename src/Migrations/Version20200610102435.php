 ...
 */
final class Version20200610102435 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__video AS SELECT id, id_canal_id, id_categoria_id, titulo, descripcion, duracion, fecha_publicacion, dislike, mg FROM video');
        $this->addSql('DROP TABLE video');
        $this->addSql('CREATE TABLE video (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, id_canal_id INTEGER NOT NULL, id_categoria_id INTEGER NOT NULL, titulo VARCHAR(100) NOT NULL COLLATE BINARY, descripcion VARCHAR(255) DEFAULT NULL COLLATE BINARY, duracion VARCHAR(15) NOT NULL COLLATE BINARY, dislike CLOB NOT NULL COLLATE BINARY --(DC2Type:array)
        , mg CLOB NOT NULL COLLATE BINARY --(DC2Type:array)
        , fecha_publicacion DATETIME NOT NULL, CONSTRAINT FK_7CC7DA2C3800B7BB FOREIGN KEY (id_canal_id) REFERENCES canal (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_7CC7DA2C10560508 FOREIGN KEY (id_categoria_id) REFERENCES categoria (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO video (id, id_canal_id, id_categoria_id, titulo, descripcion, duracion, fecha_publicacion, dislike, mg) SELECT id, id_canal_id, id_categoria_id, titulo, descripcion, duracion, fecha_publicacion, dislike, mg FROM __temp__video');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__comentario AS SELECT id, id_video_id, canal_comentado_id, canal_que_comenta_id, contenido, fecha_comentario FROM comentario');
        $this->addSql('DROP TABLE comentario');
        $this->addSql('CREATE TABLE comentario (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, id_video_id INTEGER DEFAULT NULL, canal_comentado_id INTEGER DEFAULT NULL, canal_que_comenta_id INTEGER DEFAULT NULL, contenido VARCHAR(255) NOT NULL, fecha_comentario DATE NOT NULL)');
        $this->addSql('INSERT INTO comentario (id, id_video_id, canal_comentado_id, canal_que_comenta_id, contenido, fecha_comentario) SELECT id, id_video_id, canal_comentado_id, canal_que_comenta_id, contenido, fecha_comentario FROM __temp__comentario');
        $this->addSql('DROP TABLE __temp__comentario');
        $this->addSql('CREATE INDEX IDX_4B91E702791AECDB ON comentario (id_video_id)');
        $this->addSql('CREATE INDEX IDX_4B91E702D2D578CC ON comentario (canal_comentado_id)');
        ...
        $this->addSql('DROP INDEX IDX_7CC7DA2C3800B7BB');
        $this->addSql('DROP INDEX IDX_7CC7DA2C10560508');
        $this->addSql('CREATE TEMPORARY TABLE __temp__video AS SELECT id, id_canal_id, id_categoria_id, titulo, descripcion, duracion, fecha_publicacion, mg, dislike FROM video');
        $this->addSql('DROP TABLE video');
        $this->addSql('CREATE TABLE video (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, id_canal_id INTEGER NOT NULL, id_categoria_id INTEGER NOT NULL, titulo VARCHAR(100) NOT NULL, descripcion VARCHAR(255) DEFAULT NULL, duracion VARCHAR(15) NOT NULL, mg CLOB NOT NULL --(DC2Type:array)
        , dislike CLOB NOT NULL --(DC2Type:array)
        , fecha_publicacion DATE NOT NULL)');
        $this->addSql('INSERT INTO video (id, id_canal_id, id_categoria_id, titulo, descripcion, duracion, fecha_publicacion, mg, dislike) SELECT id, id_canal_id, id_categoria_id, titulo, descripcion, duracion, fecha_publicacion, mg, dislike FROM __temp__video');
        $this->addSql('DROP TABLE __temp__video');
        $this->addSql('CREATE INDEX IDX_7CC7DA2C3800B7BB ON video (id_canal_id)');
        $this->addSql('CREATE INDEX IDX_7CC7DA2C10560508 ON video (id_categoria_id)');
    }
